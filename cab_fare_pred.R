...
setwd("D:/edwiser/Project/Cab Fare Prediction") 
getwd()
#loading Libraries
...
#train$Season <- unname(indx[as.character(train$pickup_mnth)])
#train$Season <- factor(format(train$pickup_mnth, "%q"), levels = 1:4, labels = c("winter", "spring", "summer", "fall"))
...
# mae        mse       rmse       mape 
# 1.5008521 4.4893609  2.1188112  0.1858747  
...
#mae       mse      rmse      mape 
#1.6744678 5.2695522 2.2955505 0.2085874 
...
#mae       mse      rmse      mape 
#1.6701702 5.2278851 2.2864569 0.2156063 
